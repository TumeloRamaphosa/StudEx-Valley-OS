...
export const NAV: NavItem[] = [
  ...
  { href: "/africa-expansion", label: "Africa Expansion", icon: Globe, desc: "19 countries, 4 phases, exhibitions" },
  { href: "/studex-health", label: "Studex Health", icon: Heart, desc: "🎉 Friday launch — VM partner invites" },
  { href: "/russia-vms", label: "Russia VMs", icon: Globe, desc: "6 Russian pharma clients — Tour July 2026" },
